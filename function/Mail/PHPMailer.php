 ...
 */
  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    // Security: whitelist validation for language code to prevent LFI
    $allowed = array('en', 'zh_cn', 'zh', 'ja', 'ko', 'fr', 'de', 'es', 'ru', 'pt_br', 'it', 'nl', 'tr', 'ar', 'fa', 'ro', 'pl', 'cs', 'sv', 'da', 'fi', 'hu', 'el', 'he', 'id', 'ms', 'no', 'sk', 'th', 'uk', 'vi');
    if (!in_array($langcode, $allowed)) {
      $this->SetError('Language not supported: ' . $langcode);
      return false;
    }
  ...
  */
  ...
  public function AddCustomHeader($name, $value=null) {
    ...
    if (preg_match('/[\r\n]/', $name) || ($value !== null && preg_match('/[\r\n]/', $value))) {
      $this->SetError('Header name or value contains line breaks');
      return;
    }
	if ($value === null) {
